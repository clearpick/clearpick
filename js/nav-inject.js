(function () {
  ...
  var CATEGORIES = [
    ...
    { slug: 'kitchen-dining',         icon: '🍽️', label: 'Kitchen & Dining',           count: 68,  desc: 'Appliances, cookware & more'           },
    ...
    { slug: 'fitness',                icon: '💪', label: 'Fitness Equipment',          count: 36,  desc: 'Cardio, weights & recovery'             },
    ...
    { slug: 'lawn-garden',            icon: '🌿', label: 'Lawn & Garden',              count: 28,  desc: 'Mowers, trimmers & more'                },
    { slug: 'home-entertainment',     icon: '📺', label: 'Home Entertainment',         count: 40,  desc: 'TVs, soundbars & streaming'             },
    { slug: 'cameras-photography',    icon: '📸', label: 'Cameras & Photography',      count: 21,  desc: 'Mirrorless, compact & content creation' },
    ...
    { slug: 'bbq-outdoor-cooking',    icon: '🍖', label: 'BBQ & Outdoor Cooking',      count: 20,  desc: 'Grills, smokers & griddles'             },
    { slug: 'sports-outdoors',        icon: '⛰️', label: 'Sports & Outdoors',          count: 22,  desc: 'Running, hiking & cycling'              },
    ...
    { slug: 'music-instruments',      icon: '🎸', label: 'Music & Instruments',        count: 20,  desc: 'Guitars, keyboards & accessories'       },
    { slug: 'home-comfort',           icon: '🌡️', label: 'Home Comfort',               count: 18,  desc: 'Air purifiers, fans & humidifiers'      },
  ...
  function inject() {
    ...
    if (headerActions && !document.getElementById('mob-nav-toggle')) {
      var existingBtn = headerActions.querySelector('.mobile-menu-btn');
      if (existingBtn) {
        /* Adopt the hardcoded button so we don't append a second one */
        existingBtn.id = 'mob-nav-toggle';
